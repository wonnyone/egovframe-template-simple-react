...
function EgovSupportCenter1Edit(props) {
    console.group("EgovSupportCenter1Edit");
    console.log("------------------------------");
    console.log("EgovSupportCenter1Edit [props] : ", props);

    const navigate = useNavigate();
    const location = useLocation();
    console.log("EgovSupportCenter1Edit [location] : ", location);
	//관리자 권한 체크때문에 추가(아래)
            ...
            EgovNet.requestFetch(modeInfo.editURL,
                ...
                (resp) => {
                    if (Number(resp.resultCode) === Number(CODE.RCV_SUCCESS)) {
                        navigate(URL.SUPPORT_CENTER1_LIST, {state:{bbsId : bbsId}});
                    } else {
        ...
        return (
            <div className="location">
                <ul>
                    ...
                    <li><Link to={URL.ADMIN}>고객센터</Link></li>
    ...
    console.groupEnd("EgovSupportCenter1Edit");
                        ...
                        <div className="board_view2">
                            ...
                            {sessionUserSe ==='ADM' &&
                                ...
                                <div className="right_col btn1">
                                    <Link to={URL.SUPPORT_CENTER1_LIST} className="btn btn_blue_h46 w_100">목록</Link>
                                </div>
                            </div>
                            {/* <!--// 버튼영역 --> */}
                        </div>
...
export default EgovSupportCenter1Edit;