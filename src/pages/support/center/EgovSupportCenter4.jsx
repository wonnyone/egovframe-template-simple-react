...
function EgovSupportCenter4() {
    console.log("[Start] EgovSupportCenter4 ------------------------------");
    
    const location = useLocation();
    const bbsId = location.state?.bbsId || CENTER1_BBS_ID; 

    const [searchCondition, setSearchCondition] = useState(location.state?.searchCondition2 || { bbsId: bbsId, pageIndex: 1, searchCnd: '0', searchWrd: '제품사용시 주의사항' });
    ...
    const retrieveList = useCallback((searchCondition) => {
        console.groupCollapsed("EgovSupportCenter4.retrieveList()");
        ...
        console.groupEnd("EgovSupportCenter4.retrieveList()");
    },[]);
    ...
    console.log("------------------------------EgovSupportCenter4 [End]");
    return (
            ...
            <div className="c_wrap">
                ...
                <div className="layout">
                    ...
                    <div className="contents SITE_INTRO" id="contents">
                        ...
                        <h2 className="tit_2">제품사용시 주의사항 예시</h2>
...
export default EgovSupportCenter4;