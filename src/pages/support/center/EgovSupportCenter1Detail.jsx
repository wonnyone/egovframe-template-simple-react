...
function EgovSupportCenter1Detail(props) {
    console.group("EgovSupportCenter1Detail");
    console.log("------------------------------");
    console.log("EgovSupportCenter1Detail [props] : ", props);

    const navigate = useNavigate();
    const location = useLocation();
    console.log("EgovSupportCenter1Detail [location] : ", location);
	//관리자 권한 체크때문에 추가(아래)
        ...
        EgovNet.requestFetch(deleteBoardURL,
            ...
            (resp) => {
                ...
                if (Number(resp.resultCode) === Number(CODE.RCV_SUCCESS)) {
                    alert("게시글이 삭제되었습니다.")
                    navigate(URL.SUPPORT_CENTER1_LIST ,{ replace: true });
                } else {
    ...
    console.groupEnd("EgovSupportCenter1Detail");
                            ...
                            <div className="board_btn_area">
                                {user && sessionUserSe ==='ADM' && masterBoard.bbsUseFlag === 'Y' &&
                                    <div className="left_col btn3">
                                        <Link to={{pathname: URL.SUPPORT_CENTER1_MODIFY}}
                                            state={{
                                                nttId: nttId,
                                                bbsId: bbsId
                                            }}
                                        ...
                                        <Link to={{pathname: URL.SUPPORT_CENTER1_REPLY}}
                                            state={{
                                                nttId: nttId,
                                                bbsId: bbsId
                                            }}
                                ...
                                <div className="right_col btn1">
                                    <Link to={{pathname: URL.SUPPORT_CENTER1_LIST}}
                                        state={{
                                            nttId: nttId,
                                            bbsId: bbsId,
...
export default EgovSupportCenter1Detail;