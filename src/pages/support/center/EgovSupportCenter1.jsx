...
function EgovSupportCenter1() {
    console.log("[Start] EgovSupportCenter1 ------------------------------");
    
    const location = useLocation();
    const bbsId = location.state?.bbsId || CENTER1_BBS_ID; 

    const [searchCondition, setSearchCondition] = useState(location.state?.searchCondition2 || { bbsId: bbsId, pageIndex: 1, searchCnd: '4', searchWrd: '(견적문의)' });
    ...
    const retrieveList = useCallback((searchCondition) => {
        console.groupCollapsed("EgovSupportCenter1.retrieveList()");
                        ...
                        <p className="msg_1 f_txtar w_full h_200">
                            ...
                            <div className="SERVICE_INTRO" id="contents">
                                <div class="pro-section section03">
                                    <a href={`${SERVER_URL}/${item.atchFileDownUrl}`} className="detali-view">견적요청서[다운로드]</a>
                                </div>
                            </div>
                        </p>                                               
        ...
        console.groupEnd("EgovSupportCenter1.retrieveList()");
    },[]);
    ...
    console.log("------------------------------EgovSupportCenter1 [End]");
    return (
...
export default EgovSupportCenter1;