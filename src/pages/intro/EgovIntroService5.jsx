...
function EgovIntroService5() {
    console.log("[Start] EgovIntroService5 ------------------------------");
    ...
    const [searchCondition, setSearchCondition] = useState(location.state?.searchCondition || { bbsId: bbsId, pageIndex: 1, searchCnd: '4', searchWrd: '(펄스변환기이미지)' });// 기존 조회에서 접근 했을 시 || 신규로 접근 했을 시
    const [searchCondition2, setSearchCondition2] = useState(location.state?.searchCondition2 || { bbsId: bbsId, pageIndex: 1, searchCnd: '4', searchWrd: '(펄스변환기카달로그)' });
    ...
    const retrieveList = useCallback((searchCondition) => {
        console.groupCollapsed("EgovIntroService5.retrieveList()");
        ...
        console.groupEnd("EgovIntroService5.retrieveList()");
    },[]);

    const retrieveList2 = useCallback((searchCondition2) => {
        console.groupCollapsed("EgovIntroService5.retrieveList2()");
        ...
        console.groupEnd("EgovIntroService5.retrieveList2()");
    },[]);
    ...
    console.log("------------------------------EgovIntroService5 [End]");
    return (
