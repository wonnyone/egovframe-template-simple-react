...
function EgovIntroService1List(props) {
    console.group("EgovIntroService1List");
    console.log("[Start] EgovIntroService1List ------------------------------");
    console.log("EgovIntroService1List [props] : ", props);
	
    const location = useLocation();
    console.log("EgovIntroService1List [location] : ", location);
    ...
    const retrieveList = useCallback((searchCondition) => {
        console.groupCollapsed("EgovIntroService1List.retrieveList()");
        ...
        EgovNet.requestFetch(retrieveListURL,
            ...
            (resp) => {
                ...
                resp.result.resultList.forEach(function (item, index) {
                    ...
                    mutListTag.push(
                        <Link
                            to={{pathname: URL.INTRO_SERVICE1_DETAIL}}
                            state={{
                                nttId: item.nttId,
                                bbsId: item.bbsId,
        ...
        console.groupEnd("EgovIntroService1List.retrieveList()");
    },[]);
    ...
    console.log("------------------------------EgovIntroService1List [End]");
    console.groupEnd("EgovIntroService1List");
    return (
            ...
            <div className="c_wrap">
                ...
                <div className="location">
                    <ul>
                        ...
                        <li><Link to={URL.INFORM}>제품소개</Link></li>
                        ...
                        <div className="condition">
                            <ul>
                                ...
                                {user && sessionUserSe ==='ADM' && masterBoard.bbsUseFlag === 'Y' &&
                                    <li>
                                        <Link to={URL.INTRO_SERVICE1_CREATE} state={{bbsId: bbsId}} className="btn btn_blue_h46 pd35">등록</Link>
                                    </li>
                                }
                            </ul>
                        </div>
...
export default EgovIntroService1List;