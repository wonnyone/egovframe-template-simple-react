...
function EgovIntroService1Detail(props) {
    console.group("EgovIntroService1Detail");
    console.log("------------------------------");
    console.log("EgovIntroService1Detail [props] : ", props);

    const navigate = useNavigate();
    const location = useLocation();
    console.log("EgovIntroService1Detail [location] : ", location);
	//관리자 권한 체크때문에 추가(아래)
        ...
        EgovNet.requestFetch(deleteBoardURL,
            ...
            (resp) => {
                ...
                if (Number(resp.resultCode) === Number(CODE.RCV_SUCCESS)) {
                    alert("게시글이 삭제되었습니다.")
                    navigate(URL.INTRO_SERVICE1_LIST ,{ replace: true });
                } else {
    ...
    console.groupEnd("EgovIntroService1Detail");
                            ...
                            <div className="board_btn_area">
                                {user && sessionUserSe ==='ADM' && masterBoard.bbsUseFlag === 'Y' &&
                                    <div className="left_col btn3">
                                        <Link to={{pathname: URL.INTRO_SERVICE1_MODIFY}}
                                            state={{
                                                nttId: nttId,
                                                bbsId: bbsId
                                            }}
                                        ...
                                        <Link to={{pathname: URL.INTRO_SERVICE1_REPLY}}
                                            state={{
                                                nttId: nttId,
                                                bbsId: bbsId
                                            }}
                                ...
                                <div className="right_col btn1">
                                    <Link to={{pathname: URL.INTRO_SERVICE1_LIST}}
                                        state={{
                                            nttId: nttId,
                                            bbsId: bbsId,
...
export default EgovIntroService1Detail;