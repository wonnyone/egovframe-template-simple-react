...
function EgovCntcDetail(props) {
    console.group("EgovCntcDetail");
    console.log("------------------------------");
    console.log("EgovCntcDetail [props] : ", props);

    const navigate = useNavigate();
    const location = useLocation();
    console.log("EgovCntcDetail [location] : ", location);
	//관리자 권한 체크때문에 추가(아래)
        ...
        EgovNet.requestFetch(deleteBoardURL,
            ...
            (resp) => {
                ...
                if (Number(resp.resultCode) === Number(CODE.RCV_SUCCESS)) {
                    alert("게시글이 삭제되었습니다.")
                    navigate(URL.INFORM_CNTC ,{ replace: true });
                } else {
    ...
    console.groupEnd("EgovCntcDetail");
                            ...
                            <div className="board_btn_area">
                                {user && sessionUserSe ==='ADM' && masterBoard.bbsUseFlag === 'Y' &&
                                    <div className="left_col btn3">
                                        <Link to={{pathname: URL.INFORM_CNTC_MODIFY}}
                                            state={{
                                                nttId: nttId,
                                                bbsId: bbsId
                                            }}
                                        ...
                                        <Link to={{pathname: URL.INFORM_CNTC_REPLY}}
                                            state={{
                                                nttId: nttId,
                                                bbsId: bbsId
                                            }}
                                ...
                                <div className="right_col btn1">
                                    <Link to={{pathname: URL.INFORM_CNTC}}
                                        state={{
                                            nttId: nttId,
                                            bbsId: bbsId,
