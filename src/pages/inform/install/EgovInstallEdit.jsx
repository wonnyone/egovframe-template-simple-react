...
function EgovInstallEdit(props) {
    console.group("EgovInstallEdit");
    console.log("------------------------------");
    console.log("EgovInstallEdit [props] : ", props);

    const navigate = useNavigate();
    const location = useLocation();
    console.log("EgovInstallEdit [location] : ", location);
	//관리자 권한 체크때문에 추가(아래)
            ...
            EgovNet.requestFetch(modeInfo.editURL,
                ...
                (resp) => {
                    if (Number(resp.resultCode) === Number(CODE.RCV_SUCCESS)) {
                        navigate(URL.INFORM_INSTALL, {state:{bbsId : bbsId}});
                    } else {
    ...
    console.groupEnd("EgovInstallEdit");
                        ...
                        <div className="board_view2">
                            ...
                            {sessionUserSe ==='ADM' &&
                                ...
                                <div className="right_col btn1">
                                    <Link to={URL.INFORM_INSTALL} className="btn btn_blue_h46 w_100">목록</Link>
                                </div>
                            </div>
                            {/* <!--// 버튼영역 --> */}
                        </div>
...
export default EgovInstallEdit;