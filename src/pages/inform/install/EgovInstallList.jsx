...
function EgovInstallList(props) {
    console.group("EgovInstallList");
    console.log("[Start] EgovInstallList ------------------------------");
    console.log("EgovInstallList [props] : ", props);
	
    const location = useLocation();
    console.log("EgovInstallList [location] : ", location);
    ...
    const bbsId = location.state?.bbsId || INSTALL_BBS_ID; 
    ...
    const retrieveList = useCallback((searchCondition) => {
        console.groupCollapsed("EgovInstallList.retrieveList()");
        ...
        EgovNet.requestFetch(retrieveListURL,
            ...
            (resp) => {
                ...
                resp.result.resultList.forEach(function (item, index) {
                    ...
                    mutListTag.push(
                        <Link
                            to={{pathname: URL.INFORM_INSTALL_DETAIL}}
                            state={{
                                nttId: item.nttId,
                                bbsId: item.bbsId,
        ...
        console.groupEnd("EgovInstallList.retrieveList()");
    },[]);
    ...
    console.log("------------------------------EgovInstallList [End]");
    console.groupEnd("EgovInstallList");
    return (
                        ...
                        <div className="condition">
                            <ul>
                                ...
                                {user && sessionUserSe ==='ADM' && masterBoard.bbsUseFlag === 'Y' &&
                                    <li>
                                        <Link to={URL.INFORM_INSTALL_CREATE} state={{bbsId: bbsId}} className="btn btn_blue_h46 pd35">등록</Link>
                                    </li>
                                }
                            </ul>
                        </div>
...
export default EgovInstallList;