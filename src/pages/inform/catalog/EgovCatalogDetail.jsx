...
function EgovCatalogDetail(props) {
    console.group("EgovCatalogDetail");
    console.log("------------------------------");
    console.log("EgovCatalogDetail [props] : ", props);

    const navigate = useNavigate();
    const location = useLocation();
    console.log("EgovCatalogDetail [location] : ", location);
	//관리자 권한 체크때문에 추가(아래)
        ...
        EgovNet.requestFetch(deleteBoardURL,
            ...
            (resp) => {
                ...
                if (Number(resp.resultCode) === Number(CODE.RCV_SUCCESS)) {
                    alert("게시글이 삭제되었습니다.")
                    navigate(URL.INFORM_CATALOG ,{ replace: true });
                } else {
    ...
    console.groupEnd("EgovCatalogDetail");
                            ...
                            <div className="board_btn_area">
                                {user && sessionUserSe ==='ADM' && masterBoard.bbsUseFlag === 'Y' &&
                                    <div className="left_col btn3">
                                        <Link to={{pathname: URL.INFORM_CATALOG_MODIFY}}
                                            state={{
                                                nttId: nttId,
                                                bbsId: bbsId
                                            }}
                                        ...
                                        <Link to={{pathname: URL.INFORM_CATALOG_REPLY}}
                                            state={{
                                                nttId: nttId,
                                                bbsId: bbsId
                                            }}
                                ...
                                <div className="right_col btn1">
                                    <Link to={{pathname: URL.INFORM_CATALOG}}
                                        state={{
                                            nttId: nttId,
                                            bbsId: bbsId,
...
export default EgovCatalogDetail;